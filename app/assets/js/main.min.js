...
var jquery=require("jquery");module.exports=function(e){var r=function(r,n){e.post("user/new.json",{username:r},n)},n=function(r,n,s){e.post("score/new.json",{username:r,score:n},s)};return{create_user:r,save_score:n}}(jquery);
},{"jquery":7}],2:[function(require,module,exports){
var jquery=require("jquery");module.exports=function(r){function e(e,i){var n=["-webkit-transform","-ms-transform","transform"],t=i,c=2*i;r.each(n,function(r,i){e.find(".circle .fill, .circle .mask.full").css(n[r],"rotate("+t+"deg)"),e.find(".circle .fill.fix").css(n[r],"rotate("+c+"deg)")})}return{render:e}}(jquery);
},{"jquery":7}],3:[function(require,module,exports){
var jquery=require("jquery");module.exports=function(t){var i=[].slice,e=[].indexOf||function(t){for(var i=0,e=this.length;i<e;i++)if(i in this&&this[i]===t)return i;return-1};!function(t,s){var a;return e.call(s,"ontouchstart")>=0&&t("html").addClass("touch"),a=function(){function i(i,e){var s,a=this;this.input=i,this.defaultOptions={animate:!0,snapMid:!1,classPrefix:null,classSuffix:null,theme:null,highlight:!1},this.settings=t.extend({},this.defaultOptions,e),this.settings.theme&&(this.settings.classSuffix="-"+this.settings.theme),this.input.hide(),this.slider=t("<div>").addClass("slider"+(this.settings.classSuffix||"")).css({position:"relative",userSelect:"none",boxSizing:"border-box"}).insertBefore(this.input),this.input.attr("id")&&this.slider.attr("id",this.input.attr("id")+"-slider"),this.track=this.createDivElement("track").css({width:"100%"}),this.settings.highlight&&(this.highlightTrack=this.createDivElement("highlight-track").css({width:"0"})),this.dragger=this.createDivElement("dragger"),this.slider.css({minHeight:this.dragger.outerHeight(),marginLeft:this.dragger.outerWidth()/2,marginRight:this.dragger.outerWidth()/2}),this.track.css({marginTop:this.track.outerHeight()/-2}),this.settings.highlight&&this.highlightTrack.css({marginTop:this.track.outerHeight()/-2}),this.dragger.css({marginTop:this.dragger.outerWidth()/-2,marginLeft:this.dragger.outerWidth()/-2}),this.track.mousedown(function(t){return a.trackEvent(t)}),this.settings.highlight&&this.highlightTrack.mousedown(function(t){return a.trackEvent(t)}),this.dragger.on("touchstart mousedown",function(t){if("mousedown"===t.type){if(1!==t.which)return;t.preventDefault()}return a.dragging=!0,a.dragger.addClass("dragging"),a.domDrag(t),!1}),t("body").on("touchmove mousemove",function(i){if("mousemove"===i.type&&i.preventDefault(),a.dragging)return a.domDrag(i),t("body").css({cursor:"pointer"})}),t("body").on("touchend mouseup",function(){if(a.dragging)return a.dragging=!1,a.dragger.removeClass("dragging"),t("body").css({cursor:"auto"})}),this.pagePos=0,""===this.input.val()?(this.value=this.getRange().min,this.input.val(this.value)):this.value=this.nearestValidValue(this.input.val()),this.setSliderPositionFromValue(this.value),s=this.valueToRatio(this.value),this.input.trigger("slider:ready",{value:this.value,ratio:s,position:s*this.slider.outerWidth(),el:this.slider})}return i.prototype.createDivElement=function(i){var e;return e=t("<div>").addClass(i).css({position:"absolute",top:"50%",userSelect:"none",cursor:"pointer"}).appendTo(this.slider)},i.prototype.setRatio=function(t){var i;return t=Math.min(1,t),t=Math.max(0,t),i=this.ratioToValue(t),this.setSliderPositionFromValue(i),this.valueChanged(i,t,"setRatio")},i.prototype.setValue=function(t){var i;return t=this.nearestValidValue(t),i=this.valueToRatio(t),this.setSliderPositionFromValue(t),this.valueChanged(t,i,"setValue")},i.prototype.trackEvent=function(t){if(1===t.which)return this.domDrag(t,!0),this.dragging=!0,!1},i.prototype.domDrag=function(t,i){var e,s,a,r,n,h,l;if(null==i&&(i=!1),t.originalEvent&&t.originalEvent.touches?(h=t.originalEvent.touches[0],s=h.pageX,a=h.pageY):t.touches?(l=t.touches[0],s=l.pageX,a=l.pageY):(s=t.pageX,a=t.pageY),e=s-this.slider.offset().left,e=Math.min(this.slider.outerWidth(),e),e=Math.max(0,e),this.pagePos!==e)return this.pagePos=e,r=e/this.slider.outerWidth(),n=this.ratioToValue(r),this.valueChanged(n,r,"domDrag"),this.settings.snap?this.setSliderPositionFromValue(n,i):this.setSliderPosition(e,i)},i.prototype.setSliderPosition=function(t,i){if(null==i&&(i=!1),i&&this.settings.animate){if(this.dragger.animate({left:t},200),this.settings.highlight)return this.highlightTrack.animate({width:t},200)}else if(this.dragger.css({left:t}),this.settings.highlight)return this.highlightTrack.css({width:t})},i.prototype.setSliderPositionFromValue=function(t,i){var e;return null==i&&(i=!1),e=this.valueToRatio(t),this.setSliderPosition(e*this.slider.outerWidth(),i)},i.prototype.getRange=function(){return this.settings.allowedValues?{min:Math.min.apply(Math,this.settings.allowedValues),max:Math.max.apply(Math,this.settings.allowedValues)}:this.settings.range?{min:parseFloat(this.settings.range[0]),max:parseFloat(this.settings.range[1])}:{min:0,max:1}},i.prototype.nearestValidValue=function(i){var e,s,a,r;return a=this.getRange(),i=Math.min(a.max,i),i=Math.max(a.min,i),this.settings.allowedValues?(e=null,t.each(this.settings.allowedValues,function(){if(null===e||Math.abs(this-i)<Math.abs(e-i))return e=this}),e):this.settings.step?(s=(a.max-a.min)/this.settings.step,r=Math.floor((i-a.min)/this.settings.step),(i-a.min)%this.settings.step>this.settings.step/2&&r<s&&(r+=1),r*this.settings.step+a.min):i},i.prototype.valueToRatio=function(t){var i,e,s,a,r,n,h,l;if(this.settings.equalSteps){for(l=this.settings.allowedValues,a=n=0,h=l.length;n<h;a=++n)i=l[a],("undefined"==typeof e||null===e||Math.abs(i-t)<Math.abs(e-t))&&(e=i,s=a);return this.settings.snapMid?(s+.5)/this.settings.allowedValues.length:s/(this.settings.allowedValues.length-1)}return r=this.getRange(),(t-r.min)/(r.max-r.min)},i.prototype.ratioToValue=function(t){var i,e,s,a,r;return this.settings.equalSteps?(r=this.settings.allowedValues.length,a=Math.round(t*r-.5),i=Math.min(a,this.settings.allowedValues.length-1),this.settings.allowedValues[i]):(e=this.getRange(),s=t*(e.max-e.min)+e.min,this.nearestValidValue(s))},i.prototype.valueChanged=function(i,e,s){var a;if(i.toString()!==this.value.toString())return this.value=i,a={value:i,ratio:e,position:e*this.slider.outerWidth(),trigger:s,el:this.slider},this.input.val(i).trigger(t.Event("change",a)).trigger("slider:changed",a)},i}(),t.extend(t.fn,{simpleSlider:function(){var s,r,n;return n=arguments[0],s=2<=arguments.length?i.call(arguments,1):[],r=["setRatio","setValue"],t(this).each(function(){var i,h;return n&&e.call(r,n)>=0?(i=t(this).data("slider-object"),i[n].apply(i,s)):(h=n,t(this).data("slider-object",new a(t(this),h)))})}}),t(function(){return t("[data-slider]").each(function(){var i,e,s,a;return i=t(this),s={},e=i.data("slider-values"),e&&(s.allowedValues=function(){var t,i,s,r;for(s=e.split(","),r=[],t=0,i=s.length;t<i;t++)a=s[t],r.push(parseFloat(a));return r}()),i.data("slider-range")&&(s.range=i.data("slider-range").split(",")),i.data("slider-step")&&(s.step=i.data("slider-step")),s.snap=i.data("slider-snap"),s.equalSteps=i.data("slider-equal-steps"),i.data("slider-theme")&&(s.theme=i.data("slider-theme")),i.attr("data-slider-highlight")&&(s.highlight=i.data("slider-highlight")),null!=i.data("slider-animate")&&(s.animate=i.data("slider-animate")),i.simpleSlider(s)})})}(jquery||this.Zepto,this)}(jquery);
},{"jquery":7}],4:[function(require,module,exports){
var underscore=require("underscore"),jquery=require("jquery");module.exports=function(e,r){function t(t,u){var a=n.filter(function(){return e(this).data("template")===t});return(a=r.template(a.html()))(u)}function u(r,u){var n=t(r,u);e('div[data-template="'+r+'"]').html(n)}var n=e("script[data-template]");return{compile:t,render:u}}(jquery,underscore);
...
var jquery=require("jquery"),underscore=require("underscore"),json_data=require("./data/game.json"),api=require("./components/api"),chart=require("./components/chart"),template=require("./components/template"),slider=require("./components/slider");!function(e,t,n,r){"use strict";var a=(n("body"),n("[data-loader-overlay]")),s={},i={},o={},u=0,d=[],l=1,c=0,m=400,p=null,f=null,_=null,v={1:0,1.2:-5,1.4:-10,1.6:-15,1.8:-20,2:-25,2.2:-30,2.4:-35,2.6:-40,2.8:-45,3:-50,3.2:-55},g=function(){o=json_data.questions,u=Object.keys(o).length,d=json_data.hacker_names,r.templateSettings.variable="tmpl",b(!1),h(),template.render("index"),C(1)},h=function(){s={successful_login:function(e){n('[data-template="unregistered"]').addClass("hidden"),y(e),s.render_next_question()},new_user:function(e){api.create_user(e,function(e){return e.hasOwnProperty("error_message")?(s.render_error(e.error_message),void n('[data-input="username"]').val("")):void s.successful_login(e)})},render_register_page:function(){var e=w(),t=w();t=e===t?w():t,n('div[data-template="index"]').addClass("animate-in"),n('div[data-template="unregistered"]').addClass("animate-in"),setTimeout(function(){template.render("unregistered",{name1:e,name2:t}),n("form").submit(function(e){e.preventDefault(),s.new_user(n(this).find('[data-input="username"]').val())}),n(".fancy-input input").on("keypress",function(){n(".input-error").removeClass("visible")}),n('div[data-template="unregistered"]').removeClass("animate-in")},200)},form_submission:function(){n("form").submit()},render_results_page:function(){var e=c>0?c+v[_]:0;e=e>0?e:0;var t="";e>=0&&e<=38&&(t="Your innocent mind makes you very easy prey."),e>=37&&e<=72&&(t="Your good nature makes you a good target for hackers."),e>=73&&e<=108&&(t="You could stand to think more like your enemy."),e>=109&&e<=144&&(t="No matter how devious you are, there's always more to learn."),e>=145&&e<=180&&(t="You could be a hacking genius."),api.save_score(i.username,e),n('[data-template="question"]').addClass("animate-in"),n('[data-template="results"]').addClass("animate-top"),setTimeout(function(){template.render("results",{username:i.username,user_score:e,message:t,render:function(e,t){return template.compile(e,t)}}),n('[data-template="results"]').removeClass("animate-top"),n('[data-template="question"]').remove()},400)},render_next_question:function(){C(l+1),n('div[data-template="question"]').addClass("animate-in"),setTimeout(function(){template.render("question",{q:o[l],key:l,user:i,render:function(e,t){return template.compile(e,t)}}),s.slider_register(),n('div[data-template="question"]').removeClass("animate-in")},200)},render_question_result:function(e,t,r,a,s){n('div[data-template="question"]').addClass("animate-in"),setTimeout(function(){template.render("question",{answer:e,answer_emphasis:p.text.emphasis,answer_emphasis_type:p.text.type,source:p.text.source,info:t,css_class:s,choice:r,choice_text:p.choices[r],key:l,result:!0,render:function(e,t){return template.compile(e,t)}}),n('div[data-template="question"]').removeClass("animate-in"),setTimeout(function(){chart.render(n("[data-chart]"),a)},m),l++},200)},render_error:function(e){n(".input-error").addClass("visible").find("[data-error]").text(e)},answer_submitted:function(){return p.answer===f?(q(36),void s.render_question_result(p.text.answer,"Correct! "+p.text.correct,f,p.chart.progress,null)):void s.render_question_result(p.text.answer,"Incorrect! "+p.text.incorrect,f,p.chart.progress,"strikeout")},choice_selected:function(e,t){var n=e.parents("div[data-question]").data("question"),r=e.data("choice");p=o[n],f=r,s.answer_submitted()},slider_register:function(){n("#questionSlider").simpleSlider({range:[1,3.2],allowedValues:[1,1.2,1.4,1.6,1.8,2,2.2,2.4,2.6,2.8,3,3.2],snap:!0,equalSteps:!0}).bind("slider:changed",function(e,t){s.slider_changed(e,t)}),n("#questionSlider").simpleSlider("setValue",2)},slider_changed:function(e,t){_=parseFloat(t.value)},slider_selected:function(){s.render_results_page()}},n("body").on("click",function(e){var t=n(e.target);"event"in t.data()&&s[t.data("event")](t,e)})},q=function(e){c+=e},y=function(e){i=e},b=function(e){e?a.show():a.hide()},w=function(){return d[Math.floor(Math.random()*d.length)]},C=function(e){var t="bg"+(e-1);n("html").removeClass(t).addClass("bg"+e),n(".mobile-bg img").attr("src","app/assets/img/bg"+e+".png")};n(t).ready(g)}(window,document,jquery,underscore);
},{"./components/api":1,"./components/chart":2,"./components/slider":3,"./components/template":4,"./data/game.json":5,"jquery":7,"underscore":8}],7:[function(require,module,exports){
